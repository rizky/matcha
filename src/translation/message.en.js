export default {
  ...
  'LandingPage.welcome': 'Welcome to Intra42',
  ...
  'SettingsPage.accountTitle': 'Account',
  'SettingsPage.bio': 'Bio',
  'SettingsPage.dob': 'Date of Birth',
  'SettingsPage.email': 'Email Address',
  'SettingsPage.gender': 'Gender',
  'SettingsPage.haveAccount': 'I have an account',
  'SettingsPage.interests': 'Interests',
  'SettingsPage.location': 'Location',
  'SettingsPage.name': 'Name',
  'SettingsPage.password': 'Password',
  'SettingsPage.photos': 'Photos',
  'SettingsPage.profileTitle': 'Profile',
  'SettingsPage.sexPreferences': 'Sexual Preferences',
  'SettingsPage.signUp': 'Save',
